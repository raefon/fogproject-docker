#!/bin/bash
######## Variables                                                                                                                                                           [  started  ]
Services=$(echo mariadb nginx php-fpm81 in.tftpd rpcbind nginx vsftpd FOGImageReplicator FOGImageSize FOGMulticastManager  FOGPingHosts FOGScheduler FOGSnapinHash FOGSnapinReplicator)
